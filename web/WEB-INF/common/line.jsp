	...
	<ul class="menu">
		...
		<c:if test="${admin !=null }">
		   ...
		   <li><a class="top-menu" href="javascript:;"><i
			...
			<ul class="sub-menu">
				<li><a href="UsersServlet?action=queryUsers">学生用户</a></li>
				<li><a href="UsersServlet?action=queryTeachers">教师用户</a></li>
			</ul></li>
		<li><a class="top-menu" href="javascript:;"><i
				class="iconfont mr-1">&#xe69d;</i>信息管理<i
				class="iconfont arrow float-right">&#xe66c;</i></a>
			<ul class="sub-menu">
				<li><a href="CategoryServlet?action=CategoryList">添加班级/专业/院系</a></li>
				<li><a href="CategoryServlet?action=toAddCategory">院系信息</a></li>
				<li><a href="CategoryServlet?action=toAddCategory">专业信息</a></li>
				<li><a href="CategoryServlet?action=toAddCategory">课程信息</a></li>
			</ul></li>
		<li><a class="top-menu" href="javascript:;"><i
